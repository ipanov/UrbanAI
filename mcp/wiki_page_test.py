...
"""
    ...
    try:
        ...
        if response.status_code in [200, 201]:
            ...
            # Parse response to get page details
            if response.text:
                try:
                    page_info = response.json()
                    print(f"   Page ID: {page_info.get('id')}")
                    print(f"   Page Path: {page_info.get('path')}")
                    if 'remoteUrl' in page_info:
                        print(f"   Remote URL: {page_info['remoteUrl']}")
                except:
                    pass
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("Check your Azure DevOps wiki to see the new page.")
    else:
        print("\n💥 Test failed!")
